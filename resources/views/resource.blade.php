...
<script src="{{ asset('/bower_components/ui-router-extras/release/ct-ui-router-extras.js') }}"></script>
...
<!-- Angular Smart Table -->
<script src="{{ asset('bower_components/angular-smart-table/dist/smart-table.min.js') }}"></script>
