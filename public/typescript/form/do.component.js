System.register(['angular2/core', '../service/data.service'], function(exports_1, context_1) {
    "use strict";
    ...
    return {
        ...
        execute: function() {
            FormDoComponent = (function () {
                function FormDoComponent(_dataService) {
                ...
                FormDoComponent = __decorate([
                    core_1.Component({
                        ...
                        bindings: [data_service_1.DataService]
                    }), 
