    ...
    return {
        ...
        execute: function() {
            ParticipantService = (function () {
                ...
                ParticipantService.prototype.headers = function () {
                ...
                ParticipantService.prototype.load = function (id) {
                    if (!!id) {
                        return this._http.get(app_config_1.Config.api('participant/' + id));
                    }
                    else {
                        return this._http.get(app_config_1.Config.api('participants'));
                    }
                };
                ParticipantService.prototype.add = function (participant) {
                    return this._http.post(app_config_1.Config.api('participant'), JSON.stringify(participant), this.headers());
                };
                ParticipantService.prototype.update = function (participant) {
                    return this._http.put(app_config_1.Config.api('participant/' + participant.id), JSON.stringify(participant), this.headers());
                };
